...
import {
  ...
  BookOpen, Users, User, ArrowRight, Sparkles,
} from "lucide-react";
...
const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (isAuthenticated && user?.role && !hasRedirected.current) {
      ...
      console.warn("⚠️ User is authenticated but has no role — check app_metadata in Supabase");
    }
    ...
    <div className="min-h-screen bg-background flex">
      ...
      >
        ...
        <div className="relative flex items-center gap-3 z-10">
          ...
          <div>
            <h1 className="text-xl font-bold text-white tracking-tight">ExamRoom</h1>
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-5xl font-bold text-white leading-[1.1] tracking-tight">
              Smarter<br />
              <span className="text-white/60">Exam</span><br />
              Planning.
            </h2>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-16 bg-background">
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-muted-foreground text-sm">Sign in to access your portal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className={`relative rounded-xl border transition-all duration-200 ${
                focusedField === "email" ? "border-primary ring-2 ring-primary/15" : "border-border"
              } bg-background`}>
            ...
            <div className="space-y-1.5">
              ...
              <div className={`relative rounded-xl border transition-all duration-200 ${
                focusedField === "password" ? "border-primary ring-2 ring-primary/15" : "border-border"
              } bg-background`}>
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="grid grid-cols-3 gap-2.5">
                {roleInfo.map((role) => (
                  ...
                  >
                    <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${role.color} flex items-center justify-center shadow-sm`}>
                      <role.icon className="h-4 w-4 text-white" />
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-foreground leading-tight">{role.label}</p>
